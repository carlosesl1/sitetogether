...
import type { IndustryContactForm } from "@/content/industry-contact-forms";
              ...
              {isSubmitted ? (
                ...
                >
                  ...
                  <h3 className="mt-8 text-3xl font-bold tracking-tight text-neutral-950 sm:text-4xl">
                    {formContent.successTitle ?? "Recebemos seus dados."}
                  </h3>
                ...
                >
                  ...
                  >
                    <Textarea
                      ...
                      aria-describedby={formContent.messageHint ? `${formContent.id}-message-hint` : undefined}
                      className="min-h-[150px] bg-neutral-50/70"
                    />
                    {formContent.messageHint ? (
                      <p id={formContent.id + "-message-hint"} className="text-xs font-medium leading-relaxed text-neutral-500">
                        {formContent.messageHint}
                      </p>
                    ) : null}
                  </FormField>
