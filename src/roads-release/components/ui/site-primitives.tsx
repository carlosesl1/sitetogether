...
export function ActionLink({
    ...
    return (
        <Link
            ...
            onClick={onClick}
            className={cn(
                "group inline-flex max-w-full items-center justify-center gap-3 whitespace-normal text-center font-bold uppercase leading-tight tracking-[0.14em] transition-all duration-200 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-neutral-950 focus-visible:ring-offset-2 active:scale-[0.98] sm:whitespace-nowrap sm:tracking-[0.16em]",
                fullWidth && "w-full",
