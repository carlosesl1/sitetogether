...
export function IndustryFinalCta({
  ...
  return (
    ...
    >
      <div className="absolute inset-0 bg-[radial-gradient(circle_at_85%_10%,rgba(255,255,255,0.4),transparent_36%)]" />
      <div className="container relative z-10 mx-auto px-6">
        <div className="grid items-center gap-12 lg:grid-cols-[1.1fr_0.9fr] lg:gap-24">
          <div className="min-w-0">
            <h2 className="max-w-4xl break-words text-[clamp(2.35rem,10vw,3.5rem)] font-bold leading-[0.96] tracking-[-0.04em] sm:text-6xl lg:text-[3.5rem] xl:text-[4rem]">
              {content.title}
            </h2>
          ...
          <div className="min-w-0 rounded-[36px] border border-black/5 bg-white p-6 shadow-[0_32px_70px_rgba(0,0,0,0.08)] sm:p-8 md:rounded-[48px]">
            <div>
