...
import { IndustryContactLogoStrip } from "@/roads-release/components/industry/industry-contact-logo-strip";
import type { IndustryContactForm } from "@/roads-release/content/industry-contact-forms";
      ...
      <div className="container relative z-10 mx-auto px-6">
        <div className="grid items-start gap-12 lg:grid-cols-[minmax(0,0.9fr)_minmax(420px,0.8fr)] lg:gap-16">
          <div className="min-w-0">
            ...
            <h2 id={`${formContent.id}-title`} className="mt-7 max-w-3xl text-[2.6rem] font-bold leading-[0.98] tracking-[-0.04em] sm:text-5xl lg:text-6xl">
              {content.title}
            </h2>
