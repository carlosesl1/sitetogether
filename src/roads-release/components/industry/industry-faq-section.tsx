...
import type { IndustryFaqItem } from "@/roads-release/components/industry/industry-page-types";
    ...
    >
      <div className="container mx-auto px-6">
        <div className="flex flex-col items-start gap-14 lg:flex-row lg:gap-32">
          <div className={`pt-2 lg:sticky lg:top-24 lg:w-1/3 ${wideHeading ? "xl:w-[31.125rem] xl:shrink-0" : ""}`}>
          ...
          <div className={`w-full min-w-0 lg:w-2/3 ${wideHeading ? "xl:w-auto xl:flex-1" : ""}`}>
