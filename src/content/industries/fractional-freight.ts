...
export const fractionalFreightIndustryContent = {
  ...
  hero: {
    ...
    description: "Organize dados de embarcadores, destinatários, motoristas, parceiros e sistemas — do primeiro volume ao comprovante de entrega.",
  ...
  priority: { id: "prioridades", pill: "Pontos de atenção", title: "Privacidade também é", accent: "disciplina operacional.", description: "Controles simples ajudam a reduzir exposição sem travar a movimentação da carga.", points: [
    ...
    { icon: "file", label: "Registros", title: "CIOT e MDF-e no fluxo certo", description: "Documente interfaces, responsáveis e acessos aos sistemas regulatórios." },
  ...
  support: { id: "apoio", pill: "Como a TOGETHER apoia", title: "Privacidade que acompanha", accent: "o ritmo do hub.", description: "Um apoio prático para organizar controles, contratos e rotinas com as áreas envolvidas.", items: [
    ...
    { icon: "telemetry", title: "Rastreio e comprovantes", description: "Organizamos finalidade, acesso e retenção de eventos e POD." },
  ...
  ], ctaTitle: "Quer organizar o fluxo da carga?", ctaText: "Ajudamos a definir o escopo e o próximo passo.", cta: "Agende uma Conversa" },
  ...
  faq: { pill: "Perguntas frequentes", title: "LGPD na carga", accent: "fracionada.", description: "Respostas diretas para avaliar o próximo passo.", items: [
  ...
  finalCta: { pill: "LGPD para transporte fracionado", title: "Dê clareza ao fluxo dos seus volumes.", description: "Entendemos a operação e mostramos como apoiar o projeto ou a rotina.", cta: "Agende uma Conversa", nextStep: "Uma conversa sobre a demanda, as áreas envolvidas e o próximo passo." },
