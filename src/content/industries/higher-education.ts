...
export const higherEducationIndustryContent = {
  ...
  visualFamily: "campus",
  metadata: { title: "Privacidade e LGPD para instituições de ensino superior", description: "Organize a privacidade da vida acadêmica, pesquisa, campus, EAD, pagamentos e fornecedores.", canonical: "/solucoes/privacidade-ensino-superior", socialAlt: "Estudantes adultos e professor em operação acadêmica contemporânea" },
  hero: { pill: "LGPD para ensino superior", title: "Privacidade para uma operação acadêmica que não para.", accent: "Do processo seletivo à vida no campus.", description: "A TOGETHER ajuda instituições de ensino superior a organizar dados, acessos, pesquisa, fornecedores e incidentes com responsabilidades claras.", cta: "Agende uma Conversa", image: { desktop: { avif: `${imageBase}/hero-desktop.avif`, webp: `${imageBase}/hero-desktop.webp`, png: `${imageBase}/hero-desktop.png`, width: 1672, height: 941 }, mobile: { avif: `${imageBase}/hero-mobile.avif`, webp: `${imageBase}/hero-mobile.webp`, png: `${imageBase}/hero-mobile.png`, width: 941, height: 1672 } } },
  ...
  ], ctaTitle: "Quer avaliar uma prioridade acadêmica?", ctaText: "Ajudamos a definir o escopo e o próximo passo.", cta: "Agende uma Conversa" },
  proof: [
    { value: "LGPD", label: "privacidade conectada à operação acadêmica" },
    { value: "Por fluxo", label: "critérios para campus, portal e pesquisa" },
    { value: "Com clareza", label: "responsabilidades para áreas e parceiros" },
    { value: "Em etapas", label: "ações compatíveis com a rotina institucional" },
  ],
  ...
  faq: { pill: "Perguntas frequentes", title: "LGPD no ensino", accent: "superior.", description: "Respostas diretas para avaliar o próximo passo.", items: [
    ...
    { question: "e-MEC e Censo Superior mudam a análise?", answer: "As obrigações institucionais e estatísticas fazem parte do contexto. Mapeamos dados, responsabilidades e fluxos sem substituir orientações dos órgãos competentes." },
  ...
  finalCta: { pill: "LGPD para ensino superior", title: "Coloque a privacidade em prática no campus.", description: "Entendemos sua prioridade e mostramos como organizar o próximo passo.", cta: "Agende uma Conversa", nextStep: "Uma conversa sobre a operação, as áreas envolvidas e a prioridade inicial." },
