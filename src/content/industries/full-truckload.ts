...
export const fullTruckloadIndustryContent = {
  ...
  hero: { pill: "LGPD para carga lotação", title: "Privacidade para a operação de carga lotação.", accent: "Do embarcador à entrega.", description: "A TOGETHER estrutura processos e controles para dados de embarcador, transportadora, motorista, veículo, telemetria e gestão de risco em cada viagem dedicada.", cta: "Agende uma Conversa", image: { desktop: { avif: `${imageBase}/hero-desktop.avif`, webp: `${imageBase}/hero-desktop.webp`, png: `${imageBase}/hero-desktop.png`, width: 1672, height: 941 }, mobile: { avif: `${imageBase}/hero-mobile.avif`, webp: `${imageBase}/hero-mobile.webp`, png: `${imageBase}/hero-mobile.png`, width: 941, height: 1672 } } },
  context: { id: "viagem", pill: "Onde os dados circulam", title: "Uma viagem dedicada conecta", accent: "pessoas, veículo e decisão.", description: "Na carga lotação, uma viagem dedicada conecta embarcador, transportadora, motorista, veículo, telemetria e gestão de risco.", nodes: [
    ...
    { icon: "truck", label: "Transportadora", title: "Motorista, veículo e operação", description: "Escala, documentos operacionais, acessos e responsabilidades." },
  ...
  priority: { id: "prioridades", pill: "Pontos de atenção", title: "Controle de dados sem perder", accent: "a visão da rota.", description: "Controles proporcionais protegem a operação e mantêm as decisões no tempo certo.", points: [
    ...
    { icon: "file", label: "Documentos e integrações", title: "MDF-e, CIOT quando aplicável e sistemas da viagem", description: "Registre onde há dados pessoais, quem acessa e quais responsabilidades existem." },
  ...
  ], ctaTitle: "Quer avaliar a privacidade em uma rota dedicada?", ctaText: "Avaliamos o contexto e dimensionamos o escopo inicial.", cta: "Agende uma Conversa" },
  ...
  faq: { pill: "Perguntas frequentes", title: "LGPD na carga", accent: "lotação.", description: "Respostas diretas sobre privacidade em viagens dedicadas.", items: [
    { question: "O que é carga lotação neste contexto?", answer: "É uma viagem dedicada a um embarcador, com origem e destino definidos. O termo FTL também pode aparecer como referência comercial para esse modelo." },
    ...
    { question: "CIOT e MDF-e entram no mapeamento?", answer: "Sim, quando fizerem parte da operação. Mapeamos onde dados pessoais aparecem nesses fluxos, quem acessa e quais integrações estão envolvidas." },
  ...
  finalCta: { pill: "LGPD para carga lotação", title: "Conecte privacidade à rota dedicada.", description: "Avaliamos a demanda e indicamos como estruturar o projeto ou a rotina.", cta: "Agende uma Conversa", nextStep: "Uma conversa sobre a demanda, as áreas envolvidas e o escopo inicial." },
