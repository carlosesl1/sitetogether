...
export default async function PostPage({ params }: PostPageProps) {
  ...
  return (
    <main className="min-h-screen overflow-x-clip bg-white">
      ...
      {/* Post Hero Header */}
      <section className="relative pt-[48px] pb-2">
        <div className="container px-6 mx-auto relative z-10">
          <div className="max-w-4xl mx-auto">
            ...
            {/* Featured Image */}
            <div className="relative w-full aspect-[1216/600] bg-neutral-100 shadow-2xl shadow-neutral-200/50 mb-6 animate-in fade-in slide-in-from-bottom-10 duration-1000">
              <Image
                src={featuredImage}
